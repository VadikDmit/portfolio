...
export type Project = {
  ...
  audiences?: Audience[];
  process: ProcessStep[];
  /** Optional — alternative Process layout: paragraphs beside a square media block. Takes over from `process` when set. */
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    process: [],
    processParagraphs: [
      "Проанализировал конкурентов и аналогичные сайты/сервисы.",
